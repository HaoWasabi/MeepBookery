...
-- Dumping data for table bookstoredb.address: ~8 rows (approximately)
REPLACE INTO `address` (`AddressID`, `Address`, `City`, `District`, `Ward`) VALUES
	...
	(10, 'địa chỉ 1', 'Tỉnh 1', 'Quận abc', 'Phường XYZ');
...
-- Dumping data for table bookstoredb.order: ~17 rows (approximately)
REPLACE INTO `order` (`OrderID`, `UserID`, `OrderDate`, `Status`, `TotalAmount`, `AddressID`, `PaymentMethodID`) VALUES
	(1, 1, '2025-04-10 11:50:24', 'pending', 200000.00, 1, 1),
	(2, 6, '2025-04-10 11:50:24', 'confirmed', 450000.00, 2, 2),
	(3, 6, '2025-04-08 11:50:24', 'canceled', 200000.00, 3, 3),
	(4, 6, '2025-04-09 11:50:24', 'delivered_success', 240000.00, 4, 4),
	(5, 6, '2025-04-10 11:50:24', 'pending', 500000.00, 5, 5),
	(6, 6, '2025-04-11 12:17:36', 'delivered_success', 120000.00, 7, 1),
	...
	(10, 6, '2025-04-11 13:06:05', 'delivered_success', 400000.00, 4, 1),
	(11, 6, '2025-04-11 13:07:19', 'delivered_success', 200000.00, 4, 1),
	(12, 6, '2025-04-11 13:08:21', 'delivered_success', 120000.00, 4, 2),
	(13, 6, '2025-04-11 13:14:05', 'delivered_success', 120000.00, 4, 1),
	(14, 6, '2025-04-11 13:58:16', 'delivered_success', 600000.00, 4, 1),
	(15, 6, '2025-04-11 14:18:52', 'delivered_success', 320000.00, 4, 1),
	(16, 8, '2025-04-11 14:21:53', 'delivered_success', 240000.00, 8, 3),
	(17, 8, '2025-04-11 15:47:23', 'delivered_success', 150000.00, 10, 1),
	(18, 8, '2025-04-11 17:01:30', 'pending', 120000.00, 9, 1);
...
-- Dumping data for table bookstoredb.orderdetail: ~21 rows (approximately)
...
-- Dumping data for table bookstoredb.user: ~8 rows (approximately)
REPLACE INTO `user` (`UserID`, `Name`, `Email`, `Password`, `Role`, `Phone`, `Status`, `AddressID`) VALUES
	...
	(2, 'Trần Thị B', 'tranthib@example.com', 'hashed_password', 'admin', '0987654321', 1, 2),
	...
	(6, 'Lee Chong Wei', 'wei@gmail.com', '$2y$10$6qgVol2RfAsfkRk03.mltO0hUJxsBx3wly3bf8fov.Pr1EJnESI2y', 'user', '0912345677', 1, 4),
